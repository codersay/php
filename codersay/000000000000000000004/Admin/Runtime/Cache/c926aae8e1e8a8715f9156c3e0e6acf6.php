...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <form name="form1" action="__URL__/sunsave" method="post">
    ...
    <td height="95" align="center" bgcolor="#FFFFFF">
        ...
        <table width="100%" border="0"  id="needset" cellspacing="0" cellpadding="0" style="text-align:left;border:1px solid #cfcfcf;background:#ffffff;">
          ...
          <tr>
            ...
            <td class='bline'>
            <input type="text" name="" style="width:200px" value="<?php echo ($data["mname"]); ?>" readonly="readonly"/>
          ...
          <tr>
            ...
            <td class='bline'>
                <input name="" style="width:200px" readonly="readonly" type="text" value="<?php echo ($data["colname"]); ?>"/>
                <input name="pid" type="hidden" value="<?php echo ($data["colid"]); ?>"/>
            </td>
          </tr>
          <tr>
