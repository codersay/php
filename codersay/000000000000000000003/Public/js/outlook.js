...
function changeframe(item, sortname, src, href) {
	if (item != "" && sortname != "") {
		window.top.frames["mainFrame"].getObject("show_text").innerHTML = sortname + "&nbsp;&nbsp;<img src=/Tpl/default/Admin/images/slide.gif broder=0 />&nbsp;&nbsp;" + item;
	}
	if (src != "" && href!="") {
...
document.write("<script src=/Public/js/nav.js></" + "script>");