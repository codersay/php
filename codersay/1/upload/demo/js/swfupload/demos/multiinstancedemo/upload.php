...
// Process the file
	...
	*/
	...
	createImageResole($save_path.$file_name,75,75,$save_path.$file_name,'.jpg');
...
function createImageResole($srcimg,$maxwidth,$maxheight,$name,$filetype) {
