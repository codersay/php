...
class Addons
{
    ...
    {
        return U('plugins/admin', array('pluginid'=>intval($_GET['pluginid']), 'page'=>$page) + (array)$param);
    }
    ...
    {
        return U('plugins/doAdmin', array('pluginid'=>intval($_GET['pluginid']), 'page'=>$page) + (array)$param);
    }
    ...
    public static function createAddonUrl($name, $hooks, $param = null)
    {
        $param['addon'] = $name;
        $param['hook'] = $hooks;
        return U('plugins/addonsRequest', $param);
    }
    ...
    static public function createAddonShow($name,$hooks,$param=null)
    {
        $param['addon'] = $name;
        $param['hook'] = $hooks;
        return U('plugins/displayAddons', $param);
    }
}
