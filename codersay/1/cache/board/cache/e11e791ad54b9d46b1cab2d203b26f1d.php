<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta http-equiv='refresh' content='<?php echo ($waitSecond); ?>;URL=<?php echo ($jumpUrl); ?>'><style type="text/css">			body			{ background-image:url(../Public/images/bg.gif); font-size:12px; margin:0; padding:0; }
			...
			.refresh		{ margin-bottom:20px; }
					...
					<?php else: ?>						系统将在 <span style="font-weight:bold;" class="green"><?php echo ($waitSecond); ?></span> 秒后自动跳转， 请稍后...... 如果不想等待，直接点击 <a href="<?php echo ($jumpUrl); ?>">这里</a> 跳转。<?php endif; ?></p></div></div></body></html>