...
{
  if(confirm("确定删除该记录吗?")){
    return document.myform.action='?m=Link&a=act&action=delete';
...
<div class="table-list">
	...
	<a href="javascript:noSelAll()" class="coolbg">取消</a> 
		...
		<input type="submit" name="act" value="审核" class="coolbg" onClick="document.myform.action='?m=Link&a=act&action=check';"/>&nbsp;
		<input type="submit" name="act" value="排序" class="coolbg" onClick="document.myform.action='?m=Link&a=act&action=order';"/>
        &nbsp;&nbsp;
	   </div>
</form>
</div>
